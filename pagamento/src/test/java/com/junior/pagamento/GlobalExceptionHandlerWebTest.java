...
import com.junior.pagamento.exception.GlobalExceptionHandler;
...
class GlobalExceptionHandlerWebTest {
    ...
    @Test
    void deveRetornar404_quandoResourceNotFoundException() throws Exception {
    ...
    @Test
    void deveRetornar422_quandoBusinessException() throws Exception {
    ...
    @Test
    void deveRetornar409_quandoDataIntegrityViolationException() throws Exception {
